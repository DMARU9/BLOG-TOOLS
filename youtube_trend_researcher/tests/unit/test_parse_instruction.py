"""nodes/parse_instruction.py の期間抽出ロジックの単体テスト。"""

from datetime import UTC, datetime
from unittest import mock

from youtube_trend_researcher.nodes import parse_instruction
from youtube_trend_researcher.nodes.parse_instruction import _extract_published_after_from_text


def _with_fixed_now(fixed: datetime):
    """parse_instruction.datetime を本物のまま、now() だけ固定する。"""
